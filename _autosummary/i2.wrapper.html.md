...
| `apply_func_on_cond`(func, cond, k, v)                                                             |                                                                                                                                           |
| `arg_val_converter`(func, \*\*conversion_for_arg)                                                  |                                                                                                                                           |
| `arg_val_converter_ingress`(func[, \_\_strict])                                                    |                                                                                                                                           |
...
| `convert_VK_to_KO`(kinds)                                                                          |                                                                                                                                           |
| `convert_dict_values`(to_convert, ...)                                                             |                                                                                                                                           |
| [`func_to_method_func`](#i2.wrapper.func_to_method_func)(func[, instance_params, ...]) | Get a 'method function' from a 'normal function'.                                                                                         |
| [`identity`](#i2.wrapper.identity)(x)                                       | Transparent function, returning what's been input                                                                                         |
...
| `mk_ingress_from_name_mapper`(func, name_mapper, \*)                                               |                                                                                                                                           |
| `modify_dict_on_cond`(d, cond, func)                                                               |                                                                                                                                           |
...
| `param_to_dataclass_field_tuple`(param)                                                            |                                                                                                                                           |
| `parameters_to_dict`(parameters)                                                                   |                                                                                                                                           |
| `params_used_in_funcs`(funcs)                                                                      |                                                                                                                                           |
...
| `required_params_used_in_funcs`(funcs)                                                             |                                                                                                                                           |
...
| `wrap_from_sig`(func, new_sig)                                                                     |                                                                                                                                           |

### Classes

| `ArgNameMappingIngress`(inner_sig, \*[, ...])                                                    |                                                                                |
|--------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------|
| `ArgValConverterIngress`(func[, ...])                                                            |                                                                                |
| [`Ingress`](#i2.wrapper.Ingress)(inner_sig[, kwargs_trans, ...])         | The Ingress class offers a template for creating ingress classes.              |
| [`InnerMapIngress`](#i2.wrapper.InnerMapIngress)(inner_sig[, kwargs_trans, ...]) | A class to help build ingresses systematically by mapping the inner signature. |
...
| `PickleHelperMixin`()                                                                            |                                                                                |
| [`SmartDefault`](#i2.wrapper.SmartDefault)(func_computing_default, ...)       |                                                                                |
| [`Wrap`](#i2.wrapper.Wrap)(func[, ingress, egress, name, ...])        | A function wrapper with interface modifiers.                                   |
| [`Wrapx`](#i2.wrapper.Wrapx)(func[, ingress, egress, caller, name])    |                                                                                |
...
* **Parameters:**
  * **d** ([`dict`](https://docs.python.org/3/library/stdtypes.html#dict)) – src dict
...
* **Parameters:**
  * **kwargs** ([`dict`](https://docs.python.org/3/library/stdtypes.html#dict)) – The dict containing the input kwargs that we will transform
