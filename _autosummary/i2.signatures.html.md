...
| [`PYTHON_DEFINED_CALLABLE_TYPES`](#i2.signatures.PYTHON_DEFINED_CALLABLE_TYPES)   | Callable kinds that are defined in Python (as opposed to C-level builtins) and therefore always carry authoritative signature information of their own.   |
|----------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------|

### Functions

| [`all_pk_signature`](#i2.signatures.all_pk_signature)(callable_or_signature)               | Changes all (non-variadic) arguments to be of the PK (POSITION_OR_KEYWORD) kind.                                                  |
|--------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------|
| [`assure_callable`](#i2.signatures.assure_callable)(obj)                                  | Return `obj` if callable, else an empty function carrying the signature `obj` specifies.                                          |
| [`assure_params`](#i2.signatures.assure_params)([obj])                                  | Get an interable of Parameter instances from an object.                                                                           |
| [`assure_signature`](#i2.signatures.assure_signature)(obj)                                 | Make an `inspect.Signature` from a signature, callable, parameter, iterable of parameter specs, or `None` (empty signature).      |
| [`call_forgivingly`](#i2.signatures.call_forgivingly)(func, \*args, \*\*kwargs)            | Call function on given args and kwargs, but only taking what the function needs (not choking if they're extras variables)         |
| [`call_somewhat_forgivingly`](#i2.signatures.call_somewhat_forgivingly)(func, args, kwargs)         | Call function on given args and kwargs, but with controllable argument leniency.                                                  |
| [`ch_func_to_all_pk`](#i2.signatures.ch_func_to_all_pk)(func)                               | Returns a decorated function where all arguments are of the PK kind.                                                              |
| [`ch_signature_to_all_pk`](#i2.signatures.ch_signature_to_all_pk)(callable_or_signature)         | Changes all (non-variadic) arguments to be of the PK (POSITION_OR_KEYWORD) kind.                                                  |
| [`ch_variadics_to_non_variadic_kind`](#i2.signatures.ch_variadics_to_non_variadic_kind)(func, \*[, ...])    | Replace a function's variadic parameters with a tuple and a dict parameter of the same names, returning an equivalent function.   |
| [`common_and_diff_argnames`](#i2.signatures.common_and_diff_argnames)(func1, func2)                | Get list of argument names that are common to two functions, as well as the two lists of names that are different                 |
| [`compare_signatures`](#i2.signatures.compare_signatures)(func1, func2[, ...])               | Compare the `Sig` of two callables with `signature_comparator` (equality by default).                                             |
| [`convert_to_PK`](#i2.signatures.convert_to_PK)(kinds)                                  | A `{name: POSITIONAL_OR_KEYWORD}` dict for every name in `kinds` (a `kinds_modifier`).                                            |
| [`copy_func`](#i2.signatures.copy_func)(f)                                          | Copy a function (not sure it works with all types of callables).                                                                  |
| [`defaults_are_the_same_when_not_empty`](#i2.signatures.defaults_are_the_same_when_not_empty)(dflt1, ...)      | Check if two defaults are the same when they are not empty.                                                                       |
| [`deprecation_of`](#i2.signatures.deprecation_of)(func, old_name)                        | Wrap `func` so that calling it warns that `old_name` is deprecated in favour of `func`.                                           |
| [`dflt1_is_empty_or_dflt2_is_not`](#i2.signatures.dflt1_is_empty_or_dflt2_is_not)(dflt1, dflt2)          | Why such a strange default comparison function?                                                                                   |
| [`dict_of_attribute_signatures`](#i2.signatures.dict_of_attribute_signatures)(cls)                     | Extract the signatures of all callable attributes of a class, as a `{name: signature}` dict.                                      |
| [`ensure_callable`](#i2.signatures.ensure_callable)(obj)                                  | Return `obj` if callable, else an empty function carrying the signature `obj` specifies.                                          |
| [`ensure_param`](#i2.signatures.ensure_param)(p)                                       | Make a `Param` from a parameter, a name, a `(name, default[, annotation])` tuple, or a dict of `Param` keyword arguments.         |
| [`ensure_params`](#i2.signatures.ensure_params)([obj])                                  | Get an interable of Parameter instances from an object.                                                                           |
| [`ensure_signature`](#i2.signatures.ensure_signature)(obj)                                 | Make an `inspect.Signature` from a signature, callable, parameter, iterable of parameter specs, or `None` (empty signature).      |
| [`expand_nested_key`](#i2.signatures.expand_nested_key)(d, k)                               | Items of `d`, except that a lone `{k: {k: ...}}` nesting is unwrapped first.                                                      |
| [`extract_arguments`](#i2.signatures.extract_arguments)(params, \*[, ...])                  | Extract arguments needed to satisfy the params of a callable, dealing with the dirty details.                                     |
| [`flatten_if_var_kw`](#i2.signatures.flatten_if_var_kw)(kvs, var_kw_name)                   | Yield `(key, value)` pairs, replacing a `(var_kw_name, {var_kw_name: d})` pair by the items of `d`.                               |
| [`function_caller`](#i2.signatures.function_caller)(func, args, kwargs)                   | Call `func(*args, **kwargs)`; the default "caller" of the wrapping tools.                                                         |
| [`has_signature`](#i2.signatures.has_signature)(obj[, robust])                          | Check if an object has a signature -- i.e. is callable and inspect.signature( obj) returns something.                             |
| [`ignore_any_differences`](#i2.signatures.ignore_any_differences)(x, y)                          | A comparator that always returns `True` (used to ignore a parameter attribute).                                                   |
| [`insert_annotations`](#i2.signatures.insert_annotations)(s, /, \*, ...)                     | Insert annotations in a signature.                                                                                                |
| [`is_call_compatible_with`](#i2.signatures.is_call_compatible_with)(sig1, sig2, \*[, ...])        | Return True if `sig1` is compatible with `sig2`.                                                                                  |
| [`is_signature_error`](#i2.signatures.is_signature_error)(e)                                 | Check if an exception is a signature error                                                                                        |
| [`keyed_comparator`](#i2.signatures.keyed_comparator)(comparator, key)                     | Create a key-function enabled binary operator.                                                                                    |
| [`kind_forgiving_func`](#i2.signatures.kind_forgiving_func)(func[, kinds_modifier])           | Wraps the func, changing the argument kinds according to kinds_modifier.                                                          |
| [`maybe_first`](#i2.signatures.maybe_first)(items)                                    | The first item of `items`, or `None` if there is none.                                                                            |
| [`mk_func_comparator_based_on_signature_comparator`](#i2.signatures.mk_func_comparator_based_on_signature_comparator)(...) | Make a function comparator that compares two callables through their signatures.                                                  |
| [`mk_sig_from_args`](#i2.signatures.mk_sig_from_args)(\*args_without_default, ...)         | Make a Signature instance by specifying args_without_default and args_with_defaults.                                              |
| [`name_of_obj`](#i2.signatures.name_of_obj)(o, \*[, base_name_of_obj, ...])           | Tries to find the (or "a") name for an object, even if `__name__` doesn't exist.                                                  |
| [`name_of_var_kw_argument`](#i2.signatures.name_of_var_kw_argument)(sig)                          | The name of the VAR_KEYWORD parameter of `sig`, or `None` if it has none.                                                         |
| [`normalized_func`](#i2.signatures.normalized_func)(func)                                 | Wrap `func` so its call arguments are re-bound through `func`'s own signature.                                                    |
| [`param_attribute_dict`](#i2.signatures.param_attribute_dict)(...)                             | Zip four comparison results into a `{name, kind, default, annotation}` dict (an `aggreg`).                                        |
| [`param_binary_func`](#i2.signatures.param_binary_func)(param1, param2, \*[, name, ...])    | Compare two parameters.                                                                                                           |
| [`param_comparator`](#i2.signatures.param_comparator)(param1, param2, \*[, name, ...])     | Compare two parameters.                                                                                                           |
| [`param_differences_dict`](#i2.signatures.param_differences_dict)(param1, param2, \*[, ...])     | Makes a dictionary exibiting the differences between two parameters.                                                              |
| [`param_for_kind`](#i2.signatures.param_for_kind)([name, kind, with_default])            | Make an `inspect.Parameter` of a given kind, with a generated name and default if not given (handy in tests).                     |
| [`param_has_default_or_is_var_kind`](#i2.signatures.param_has_default_or_is_var_kind)(p)                   | Whether the parameter is optional in a call: it has a default or is variadic.                                                     |
| [`parameter_to_dict`](#i2.signatures.parameter_to_dict)(p)                                  | The `name`, `kind`, `default` and `annotation` of a parameter, as a dict.                                                         |
| [`params_of`](#i2.signatures.params_of)(obj)                                        | The list of `Parameter` objects of a signature, a name-to-parameter mapping, or a callable.                                       |
| [`postprocess`](#i2.signatures.postprocess)(egress)                                   | Make a decorator that applies `egress` to the output of the wrapped function.                                                     |
| [`replace_kwargs_using`](#i2.signatures.replace_kwargs_using)(sig)                             | Decorator that replaces the variadic keyword argument of the target function using the `sig`, the signature of a source function. |
| [`resolve_function`](#i2.signatures.resolve_function)(obj)                                 | Get the underlying function of a property or cached_property                                                                      |
| [`return_tuple`](#i2.signatures.return_tuple)(x, y)                                    | A comparator that returns the `(x, y)` pair itself instead of a verdict.                                                          |
| [`set_signature_of_func`](#i2.signatures.set_signature_of_func)(func, parameters, \*, ...)      | Set the signature of a function, with sugar.                                                                                      |
| [`sig_to_dataclass`](#i2.signatures.sig_to_dataclass)(sig, \*[, cls_name, bases, ...])     | Make a `class` (through `make_dataclass`) from the given signature.                                                               |
| [`sort_params`](#i2.signatures.sort_params)(params)                                   |                                                                                                                                   |
| [`use_interface`](#i2.signatures.use_interface)(interface_sig)                          | Use interface_sig as (enforced/validated) signature of the decorated function.                                                    |
| [`validate_signature`](#i2.signatures.validate_signature)(func)                              | Validates the signature of a function.                                                                                            |

### Classes

| [`MissingArgValFor`](#i2.signatures.MissingArgValFor)(argname)                    | A simple class to wrap an argument name, indicating that it was missing somewhere.                                                                                     |
|-----------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [`P`](#i2.signatures.P)                                            |                                                                                                                                                                        |
| [`Param`](#i2.signatures.Param)(name[, kind])                          | A thin wrap of Parameters: Adds shorter aliases to argument kinds and a POSITIONAL_OR_KEYWORD default to the argument kind to make it faster to make Parameter objects |
| [`Sig`](#i2.signatures.Sig)([obj, name, \_\_validate_parameters_\_]) | A subclass of inspect.Signature that has a lot of extra api sugar, such as                                                                                             |
| [`SigPair`](#i2.signatures.SigPair)(sig1, sig2)                          | Compare two signatures: shared and missing names, and per-parameter differences.                                                                                       |

### Exceptions

| [`FuncCallNotMatchingSignature`](#i2.signatures.FuncCallNotMatchingSignature)                 | Raise when the call signature is not valid   |
|-----------------------------------------------------------------------------------------------|----------------------------------------------|
| [`IncompatibleSignatures`](#i2.signatures.IncompatibleSignatures)(\*args[, sig1, sig2]) |                                              |
| [`InvalidSignature`](#i2.signatures.InvalidSignature)                             | Raise when a signature is not valid          |
...
alias of [`Param`](#i2.signatures.Param)
...
* **Parameters:**
  * **sig1** ([`Callable`](https://docs.python.org/3/library/collections.abc.html#collections.abc.Callable) | [`Sig`](#i2.signatures.Sig)) – First signature or signature-able object.
  * **sig2** ([`Callable`](https://docs.python.org/3/library/collections.abc.html#collections.abc.Callable) | [`Sig`](#i2.signatures.Sig)) – Second signature or signature-able object.
...
* **Parameters:**
  * **sig1** ([`Sig`](#i2.signatures.Sig)) – The main signature.
  * **sig2** ([`Sig`](#i2.signatures.Sig)) – The signature to be compared with.
