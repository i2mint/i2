...
| [`dict_to_graph`](#i2.footprints.dict_to_graph)(graph[, from_key_to_values, ...]) | A function to convert a dictionary to a graphviz string.                                                            |
| `dunders_diff`(x, y)                                                                             |                                                                                                                     |
...
| [`trace_class_decorator`](#i2.footprints.trace_class_decorator)(cls[, names_and_sigs])    | A decorator that adds methods to a class that trace the operations that are performed on an instance of that class. |

### Classes

| [`AttributeVisitor`](#i2.footprints.AttributeVisitor)(object_name)   |                                                                       |
|----------------------------------------------------------------------------------|-----------------------------------------------------------------------|
| [`Import`](#i2.footprints.Import)(module, name, alias)     |                                                                       |
| [`MethodTrace`](#i2.footprints.MethodTrace)()                   | A class that can be used to trace the methods that are called on it.  |
...
* **Parameters:**
  * **cls** ([`type`](https://docs.python.org/3/library/functions.html#type)) – The class or instance to analyze
...
* **Parameters:**
  * **graph** ([`dict`](https://docs.python.org/3/library/stdtypes.html#dict)) – The graph, in the form of a to convert to graphviz.
  * **from_key_to_values** ([`bool`](https://docs.python.org/3/library/functions.html#bool)) – Whether the keys of the graph are from nodes or to nodes.
  ...
  * **indent** ([`str`](https://docs.python.org/3/library/stdtypes.html#str)) – The indent to use for the graphviz string.
  * **graphviz_template** – The template to use for the graphviz string.
  * **display** ([`bool`](https://docs.python.org/3/library/functions.html#bool) | [`Callable`](https://docs.python.org/3/library/collections.abc.html#collections.abc.Callable)) – Whether to display the graphviz string as a graph in a jupyter notebook. Requires graphviz.
* **Return type:**
...
### i2.footprints.trace_class_decorator(cls, names_and_sigs=(('_\_gt_\_', <Sig (self, b, /)>), ('_\_index_\_', <Sig (self, /)>), ('_\_inv_\_', <Sig (self, /)>), ('_\_getitem_\_', <Sig (self, key: KT, /) -> ~VT>), ('_\_lshift_\_', <Sig (self, b, /)>), ('_\_isub_\_', <Sig (self, b, /)>), ('_\_add_\_', <Sig (self, b, /)>), ('_\_irshift_\_', <Sig (self, b, /)>), ('_\_setitem_\_', <Sig (self, key: KT, value: VT, /) -> Any>), ('_\_imatmul_\_', <Sig (self, b, /)>), ('_\_truediv_\_', <Sig (self, b, /)>), ('_\_ipow_\_', <Sig (self, b, /)>), ('_\_pow_\_', <Sig (self, b, /)>), ('_\_call_\_', <Sig (self, /, \*args, \*\*kwargs)>), ('_\_concat_\_', <Sig (self, b, /)>), ('_\_invert_\_', <Sig (self, /)>), ('_\_le_\_', <Sig (self, b, /)>), ('_\_contains_\_', <Sig (self, key: KT, /) -> bool>), ('_\_lt_\_', <Sig (self, b, /)>), ('_\_sub_\_', <Sig (self, b, /)>), ('_\_iand_\_', <Sig (self, b, /)>), ('_\_iconcat_\_', <Sig (self, b, /)>), ('_\_eq_\_', <Sig (self, b, /)>), ('_\_imod_\_', <Sig (self, b, /)>), ('_\_imul_\_', <Sig (self, b, /)>), ('_\_pos_\_', <Sig (self, /)>), ('_\_rshift_\_', <Sig (self, b, /)>), ('_\_matmul_\_', <Sig (self, b, /)>), ('_\_mod_\_', <Sig (self, b, /)>), ('_\_mul_\_', <Sig (self, b, /)>), ('_\_or_\_', <Sig (self, value, /)>), ('_\_ilshift_\_', <Sig (self, b, /)>), ('_\_abs_\_', <Sig (self, /)>), ('_\_xor_\_', <Sig (self, b, /)>), ('_\_ifloordiv_\_', <Sig (self, b, /)>), ('_\_ior_\_', <Sig (self, value, /)>), ('_\_ixor_\_', <Sig (self, b, /)>), ('_\_itruediv_\_', <Sig (self, b, /)>), ('_\_ne_\_', <Sig (self, b, /)>), ('_\_not_\_', <Sig (self, /)>), ('_\_delitem_\_', <Sig (self, key: KT, /) -> Any>), ('_\_iadd_\_', <Sig (self, b, /)>), ('_\_ge_\_', <Sig (self, b, /)>), ('_\_floordiv_\_', <Sig (self, b, /)>), ('_\_neg_\_', <Sig (self, /)>), ('_\_and_\_', <Sig (self, b, /)>), ('_\_ror_\_', <Sig (self, value, /)>), ('_\_reversed_\_', <Sig (self, /)>), ('_\_iter_\_', <Sig (self, /) -> collections.abc.Iterator[~KT]>), ('_\_len_\_', <Sig (self, /) -> int>), ('_\_rmod_\_, ', <Sig (self, other)>), ('_\_rmul_\_, ', <Sig (self, other)>), ('_\_rand_\_, ', <Sig (self, other)>), ('_\_rlshift_\_, ', <Sig (self, other)>), ('_\_rdiv_\_, ', <Sig (self, other)>), ('_\_radd_\_, ', <Sig (self, other)>), ('_\_rtruediv_\_, ', <Sig (self, other)>), ('_\_rsub_\_, ', <Sig (self, other)>), ('_\_rfloordiv_\_, ', <Sig (self, other)>), ('_\_rpow_\_, ', <Sig (self, other)>), ('_\_rrshift_\_, ', <Sig (self, other)>), ('_\_rxor_\_, ', <Sig (self, other)>), ('_\_rdivmod_\_, ', <Sig (self, other)>)), method_factory=<function \_dflt_method_factory>)
