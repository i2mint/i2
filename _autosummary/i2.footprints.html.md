...
### i2.footprints.trace_class_decorator(cls, names_and_sigs=(('_\_le_\_', <Sig (self, b, /)>), ('_\_iconcat_\_', <Sig (self, b, /)>), ('_\_isub_\_', <Sig (self, b, /)>), ('_\_ne_\_', <Sig (self, b, /)>), ('_\_add_\_', <Sig (self, b, /)>), ('_\_iand_\_', <Sig (self, b, /)>), ('_\_lt_\_', <Sig (self, b, /)>), ('_\_rshift_\_', <Sig (self, b, /)>), ('_\_index_\_', <Sig (self, /)>), ('_\_lshift_\_', <Sig (self, b, /)>), ('_\_pos_\_', <Sig (self, /)>), ('_\_floordiv_\_', <Sig (self, b, /)>), ('_\_mod_\_', <Sig (self, b, /)>), ('_\_xor_\_', <Sig (self, b, /)>), ('_\_invert_\_', <Sig (self, /)>), ('_\_itruediv_\_', <Sig (self, b, /)>), ('_\_getitem_\_', <Sig (self, key: KT, /) -> ~VT>), ('_\_and_\_', <Sig (self, b, /)>), ('_\_gt_\_', <Sig (self, b, /)>), ('_\_inv_\_', <Sig (self, /)>), ('_\_eq_\_', <Sig (self, b, /)>), ('_\_sub_\_', <Sig (self, b, /)>), ('_\_pow_\_', <Sig (self, b, /)>), ('_\_ilshift_\_', <Sig (self, b, /)>), ('_\_ipow_\_', <Sig (self, b, /)>), ('_\_or_\_', <Sig (self, value, /)>), ('_\_truediv_\_', <Sig (self, b, /)>), ('_\_mul_\_', <Sig (self, b, /)>), ('_\_call_\_', <Sig (self, /, \*args, \*\*kwargs)>), ('_\_concat_\_', <Sig (self, b, /)>), ('_\_delitem_\_', <Sig (self, key: KT, /) -> Any>), ('_\_not_\_', <Sig (self, /)>), ('_\_matmul_\_', <Sig (self, b, /)>), ('_\_setitem_\_', <Sig (self, key: KT, value: VT, /) -> Any>), ('_\_imatmul_\_', <Sig (self, b, /)>), ('_\_abs_\_', <Sig (self, /)>), ('_\_neg_\_', <Sig (self, /)>), ('_\_imul_\_', <Sig (self, b, /)>), ('_\_irshift_\_', <Sig (self, b, /)>), ('_\_ge_\_', <Sig (self, b, /)>), ('_\_iadd_\_', <Sig (self, b, /)>), ('_\_ixor_\_', <Sig (self, b, /)>), ('_\_ior_\_', <Sig (self, value, /)>), ('_\_contains_\_', <Sig (self, key: KT, /) -> bool>), ('_\_imod_\_', <Sig (self, b, /)>), ('_\_ifloordiv_\_', <Sig (self, b, /)>), ('_\_reversed_\_', <Sig (self, /)>), ('_\_iter_\_', <Sig (self, /) -> collections.abc.Iterator[~KT]>), ('_\_ror_\_', <Sig (self, value, /)>), ('_\_len_\_', <Sig (self, /) -> int>), ('_\_rmul_\_, ', <Sig (self, other)>), ('_\_rtruediv_\_, ', <Sig (self, other)>), ('_\_rdivmod_\_, ', <Sig (self, other)>), ('_\_rxor_\_, ', <Sig (self, other)>), ('_\_rlshift_\_, ', <Sig (self, other)>), ('_\_radd_\_, ', <Sig (self, other)>), ('_\_rsub_\_, ', <Sig (self, other)>), ('_\_rdiv_\_, ', <Sig (self, other)>), ('_\_rfloordiv_\_, ', <Sig (self, other)>), ('_\_rpow_\_, ', <Sig (self, other)>), ('_\_rand_\_, ', <Sig (self, other)>), ('_\_rrshift_\_, ', <Sig (self, other)>), ('_\_rmod_\_, ', <Sig (self, other)>)), method_factory=<function \_dflt_method_factory>)
