...
| `preprocess`(pre)                                                                                   |                                                                                                         |
| [`preprocess_arguments`](#i2.deco.preprocess_arguments)(pre)                          | Apply a function to args, kwargs and use the transformed in the decorated function                      |
...
| [`OutputPostProcessingError`](#i2.deco.OutputPostProcessingError)   |    |
|------------------------------------------------------------------------------|----|
...
- Using a function that does a lot to make several functions that do less.
  : (e.g. Extracting/making a python object from a function returning a raw http 
    <br/>
    ```
    response_
    ```
