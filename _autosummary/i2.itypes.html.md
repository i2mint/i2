...
| `dot_string_of_callable_typ`(typ)                                                                  |                                                                                              |
|----------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------|
| `dot_strings_of_callable_types`(\*typs[, ...])                                                     |                                                                                              |
| [`input_and_output_types`](#i2.itypes.input_and_output_types)(typ)                       | Returns the input and output types                                                           |
| `is_a_new_type`(typ)                                                                               |                                                                                              |
...
* **Return type:**
  [`dict`](https://docs.python.org/3/library/stdtypes.html#dict)[[`TypeVar`](https://docs.python.org/3/library/typing.html#typing.TypeVar)(`KT`), [`bool`](https://docs.python.org/3/library/functions.html#bool)]
* **Returns:**
...
* **Parameters:**
  * **obj** ([`Any`](https://docs.python.org/3/library/typing.html#typing.Any)) – The object to classify.
  * **assert_unique** ([`bool`](https://docs.python.org/3/library/functions.html#bool)) – Ensures only one kind matches, if True.
* **Return type:**
...
* **Parameters:**
  ...
  * **doc** ([`str`](https://docs.python.org/3/library/stdtypes.html#str) | [`None`](https://docs.python.org/3/library/constants.html#None)) – Optional string to put in \_\_doc_\_ attribute
  * **aka** ([`Iterable`](https://docs.python.org/3/library/collections.abc.html#collections.abc.Iterable) | [`None`](https://docs.python.org/3/library/constants.html#None)) – Optional set (or any iterable) to put in \_aka attribute,
