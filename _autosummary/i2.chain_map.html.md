...
| [`is_iterable`](#i2.chain_map.is_iterable)(x)          | Similar in nature to [`callable()`](https://docs.python.org/3/library/functions.html#callable), `is_iterable` returns `True` if an object is <br/><br/>```<br/>`iterable`_<br/>```<br/><br/>, `False` if not.   |
|--------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `is_mapping`(x)                                                          |                                                                                                                                                                                                                 |
| `not_mapping`(x)                                                         |                                                                                                                                                                                                                 |
...
Similar in nature to [`callable()`](https://docs.python.org/3/library/functions.html#callable), `is_iterable` returns
`True` if an object is 
